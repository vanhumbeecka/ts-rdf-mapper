import {
  DataFactory, Literal, NamedNode, Prefixes, Quad, Quad_Object, Quad_Predicate, Quad_Subject, Term, Writer
} from 'n3'
...
export class SerializerProcessor {
  ...
  private processClazzAnnotatedPropertyValue(value: any | any[], subject: Quad_Subject, predicate: Quad_Predicate, xsdDataType: NamedNode, inversedPredicate: string, serializer: any): void {
  ...
  private processClazzAnnotatedObjectValue(value: any, subject: Quad_Subject, predicate: Quad_Predicate, xsdDataType: NamedNode, inversedPredicate: string, serializer: any): void {
    if (serializer) {
